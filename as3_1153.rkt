...
(cond
  ...
  [(= part 2)
  (cond [(songstate-v1b ss)(pstream-set-volume! 1a 1/8)]
        [else (pstream-set-volume! 1a 0)])]
  [(= part 3)
  (cond [(songstate-v2a ss)(pstream-set-volume! 1a 1/8)]
        [else (pstream-set-volume! 1a 0)])]
  [(= part 4)
  (cond [(songstate-v2b ss)(pstream-set-volume! 1a 1/8)]
        [else (pstream-set-volume! 1a 0)])]
  [(= part 5)
  (cond [(songstate-violaa ss)(pstream-set-volume! 1a 1/8)]
        [else (pstream-set-volume! 1a 0)])]
  [(= part 6)
  (cond [(songstate-violab ss)(pstream-set-volume! 1a 1/8)]
        [else (pstream-set-volume! 1a 0)])]
  [(= part 7)
  (cond [(songstate-celloa ss)(pstream-set-volume! 1a 1/8)]
        [else (pstream-set-volume! 1a 0)])]
  [(= part 8)
  (cond [(songstate-cellob ss)(pstream-set-volume! 1a 1/8)]
        [else (pstream-set-volume! 1a 0)])]))
